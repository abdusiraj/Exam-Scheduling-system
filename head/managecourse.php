        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="managecourse.php" class="nav-item nav-link active"><i class="fa fa-th me-2"></i>Manage Course</a>
                   ...
                   while($row1=$run1->fetch_assoc()){
                    ...
                    //echo '<tr class="odd gradeX" id="rec">';
                     ?>
                                    <tr>
                                        ...
                                        <td>
                                        <a rel="facebox" href="deletecourse.php?Id=<?php echo $row1['id']; ?>"  class="btn btn-sm btn-danger">delete</a>
                                        </td>
                                    </tr>
                                    <?php }?>
                                </tbody>
                    ...
                    <div class="col-sm-12 col-xl-3">
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <form action="addcoursepro.php" method="post">
                              <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="ccode" class="form-control" id="text">
                                </div>
