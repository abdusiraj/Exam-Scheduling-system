                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-9">
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            include "../connection.php";
                        //    `type`, `course`, `sem`, `year`, `room`, `ins_id
                 $sql = "SELECT * FROM schedule sl INNER JOIN semister sm ON sl.sem = sm.sem where sm.status =1";
                    ...
                    //echo '<tr class="odd gradeX" id="rec">';
                     ?>
                                    <tr>
                                        ...
                                        <td>
                                        <a rel="facebox" href="deletesem.php?Id=<?php echo $row1['id']; ?>"  class="btn btn-sm btn-Primary">Manage</a>
                                        </td>
                                    </tr>
                                    <?php }?>
                                </tbody>
                            ...
                            <form action="addexampro.php" method="post">
                                ...
                                <?php
                                  ...
                                  while($row=$run->fetch_assoc()){    
                                   $sem= $row['sem'];      
                                   $sq=$con->query("SELECT * FROM `department` WHERE `hed_id`='$head_id'");
                                    $get=$sq->fetch_assoc();
                                    //$sql=$con->query("SELECT * FROM `course` WHERE `sem`='$sem'");
                                    //$get=$sql->fetch_assoc();
                                 ?>
                                    ...
                                    <div class="mb-3">
                                     ...
                                     <input type="text" name="dep" class="form-control" id="text" readonly value="<?php echo $get['name']; ?>"> 
                                    </div>
                                <?php
                                  }
                                ?>
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="year" class="form-control" id="text" readonly value="<?php  ?>">
                                </div>
                                <div class="mb-3">
