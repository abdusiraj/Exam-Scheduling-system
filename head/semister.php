        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="semister.php" class="nav-item nav-link active "><i class="fa fa-keyboard me-2"></i>Manage Semister</a>
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-9">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Semister List</h6>
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th scope="col">#</th>
                   ...
                   while($row=$run->fetch_assoc()){
                     ...
                     ?>
                                    <tr>
                                        ...
                                        <td><?php if($row['status'] == '1'): ?>
								              <span class="badge badge-sm bg-success">Open</span>
							              <?php elseif($row['status'] == '0'): ?>
								               <span class="badge badge-sm bg-danger">Closed</span>
							              <?php endif; ?>
                                        </td>
                                        <td>
                                        <a rel="facebox" href="deletesem.php?Id=<?php echo $row['id']; ?>"  class="btn btn-sm btn-danger">delete</a>
                                        </td>
                                        <td>
                                        <div class="d-flex align-items-center">
                                            <a href="activesem.php?Id=<?php echo $row['id']; ?>" class="btn btn-icon-only btn-rounded btn-outline-success mb-0 me-3 btn-sm d-flex align-items-center justify-content-center"><i class="fas fa-arrow-down"></i></a>
                                            <div class="d-flex flex-column">
                                               <h6 class="mb-1 text-white text-sm">Open</h6>
                                            </div>
                                        </div>
                                        </td>
                                    </tr>
                    ...
                    <div class="col-sm-12 col-xl-3">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">ADD Semister</h6>
                            <form action="semaddpro.php" method="post">
                                <div class="mb-3">
                                <select name="sem" class="form-select" id="floatingSelect"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="year" class="form-control" id="text">
                                </div>
