        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="instructor.php" class="nav-item nav-link "><i class="fa fa-th me-2"></i>Manage Course</a>
            ...
            <nav class="navbar navbar-expand bg-secondary navbar-dark sticky-top px-4 py-0">
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown">
                     ...
                     <?php
                    include "../connection.php";
                      $pro = $con->query("SELECT * FROM `head` where `hed_id`='$head_id'");
                      $prof = $pro->fetch_assoc();
                      ?>
                        ...
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <div class="owl-carousel testimonial-carousel">
                                <div class="testimonial-item text-center">
                                    ...
                                    <h5 class="mb-1">Full Name: <?php echo $prof['fname'];echo " ";echo $prof['mname'];echo " ";echo $prof['lname']; ?></h5>
